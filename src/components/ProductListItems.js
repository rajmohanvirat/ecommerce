...
export default function ProductListItem(props) {
 ...
 />     
        ...
        <h6 className="mt-2 me-4">Rating: {props.rating}</h6>
          ...
          <button className="btn btn-danger ms=3"onClick={props.incrementItem}>+</button><span className='ms-3'>Quantity {props.count}</span>
           <button className="btn btn-danger ms-3" onClick={props.decrementItem}>-</button>
           <button className="btn btn-danger ms-3"
            onClick={props.removeItem}>Remove</button>
